...
@SPIMeta(id="send_fail_sms")
@Order(100)
@Groups({OETHandlerConstant.FLOW_ENGINE_TYPE,OETHandlerConstant.SERVICE_ENGINE_TYPE,OETHandlerConstant.BPL_ENGINE_TYPE})
public class OETSendFailSmsHandler implements OETExceptionHandler{
	
    public static final SysLog log = SysLogUtil.getSysLog(OETSendFailSmsHandler.class);
    //短信相关专项日志
    public static final BizLog smsLog = BizLogUtil.getBizLog("sms", OETSendFailSmsHandler.class);
