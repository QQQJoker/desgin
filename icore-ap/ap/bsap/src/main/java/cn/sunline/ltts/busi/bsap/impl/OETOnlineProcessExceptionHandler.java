...
import cn.sunline.adp.cedar.engine.online.handler.OETExceptionHandler;
...
@SPIMeta(id = "bsap_online_process_exception")
@Order(900)
@Groups({OETHandlerConstant.FLOW_ENGINE_TYPE})
public class OETOnlineProcessExceptionHandler implements OETExceptionHandler {

	private static final SysLog log = SysLogUtil.getSysLog(OETOnlineProcessExceptionHandler.class);
	
	public static final String SPI_ID = "bsap_online_process_exception";
