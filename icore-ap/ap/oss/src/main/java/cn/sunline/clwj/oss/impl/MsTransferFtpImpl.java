...
import cn.sunline.clwj.oss.impl.inner.FtpFileTransferClientImpl;
...
public class MsTransferFtpImpl implements MsTransfer {
	FtpFileTransferClientImpl innerImpl=new FtpFileTransferClientImpl();
