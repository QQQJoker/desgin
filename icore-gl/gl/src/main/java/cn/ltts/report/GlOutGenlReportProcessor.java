...
import cn.sunline.ltts.busi.sys.type.GlEnumType.E_YESORNO;
	  ...
	  *
	  */
public class GlOutGenlReportProcessor implements cn.sunline.adp.cedar.busi.sdk.report.LttsReportDataProcessor<cn.sunline.ltts.busi.gl.type.GlReport.GlBuinessCondition, cn.sunline.ltts.busi.gl.report.GlOutGenl.Input, cn.sunline.ltts.busi.gl.type.GlReport.GlTiller> {
	
	@Override
	public LttsReportQueryExecuter<cn.sunline.ltts.busi.gl.type.GlReport.GlBuinessCondition> getMainDataQueryExecuter(cn.sunline.ltts.busi.gl.report.GlOutGenl.Input input) {
		...
		para.add("on_bal_sheet_ind", E_YESORNO.NO);
	...
	@Override
	public cn.sunline.ltts.busi.gl.type.GlReport.GlTiller getAssistentData(cn.sunline.ltts.busi.gl.report.GlOutGenl.Input input) {
