...
public class gl86DataProcessor
		extends
		AbstractBatchDataProcessorWithJobDataItem<cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Input, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Property, cn.sunline.ltts.busi.iobus.type.pb.IoBrComplexType.IoBrchInfo, cn.sunline.ltts.busi.gl.type.GlReport.GlCcyAndBranchList> {
	private static final BizLog bizlog = BizLogUtil.getBizLog(gl86DataProcessor.class);
	 ...
	 */
	@Override
	public void process(String jobId, int index, cn.sunline.ltts.busi.gl.type.GlReport.GlCcyAndBranchList dataItem, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Input input,
			cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Property property) {
		...
		para.add(GlDict.A.file_name.getId(), E_REPORTNAME.PROFIT_SHEET.getLongName() + "_" + ccyCode + E_GLDATEINTERVAL.DAILY.getLongName());

		GlReport.genOneReport("GlProfitLoss", dataItem.getBranch_id(), E_CYCLETYPE.DAY, para);
		...
		if (DateTools2.isLastDay("M", trxnDate)) {
			...
			para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
			para.add(GlDict.A.ccy_code.getId(), ccyCode);
			para.add(GlDict.A.file_name.getId(), E_REPORTNAME.PROFIT_SHEET.getLongName() + "_" + ccyCode + E_GLDATEINTERVAL.MONTHLY.getLongName());
		...
		if (DateTools2.isLastDay("Q", trxnDate)) {
			...
			para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
			para.add(GlDict.A.ccy_code.getId(), ccyCode);
			para.add(GlDict.A.file_name.getId(), E_REPORTNAME.PROFIT_SHEET.getLongName() + "_" + ccyCode + E_GLDATEINTERVAL.SEASONLY.getLongName());
		...
		if (DateTools2.isLastDay("H", trxnDate)) {
			...
			para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
			para.add(GlDict.A.ccy_code.getId(), ccyCode);
			para.add(GlDict.A.file_name.getId(), E_REPORTNAME.PROFIT_SHEET.getLongName() + "_" + ccyCode + E_GLDATEINTERVAL.HALF_YEARLY.getLongName());
		...
		if (DateTools2.isLastDay("Y", trxnDate)) {
			...
			para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
			para.add(GlDict.A.ccy_code.getId(), ccyCode);
			para.add(GlDict.A.file_name.getId(), E_REPORTNAME.PROFIT_SHEET.getLongName() + "_" + ccyCode + E_GLDATEINTERVAL.YEARLY.getLongName());
		...
		if (CommToolsAplt.prcRunEnvs().getYreddt().equals(trxnDate)) {
			...
			para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
			para.add(GlDict.A.ccy_code.getId(), ccyCode);
			para.add(GlDict.A.file_name.getId(), E_REPORTNAME.PROFIT_SHEET.getLongName() + "_trial_" + ccyCode + E_GLDATEINTERVAL.YEARLY.getLongName());
	 ...
	 */
	@Override
	public BatchDataWalker<cn.sunline.ltts.busi.iobus.type.pb.IoBrComplexType.IoBrchInfo> getBatchDataWalker(cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Input input,
			cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Property property) {
		// 调用服务查询所有机构列表
	 ...
	 * @return
	 */
	public BatchDataWalker<cn.sunline.ltts.busi.gl.type.GlReport.GlCcyAndBranchList> getJobBatchDataWalker(cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Input input,
			cn.sunline.ltts.busi.gltran.batchtran.intf.Gl86.Property property, cn.sunline.ltts.busi.iobus.type.pb.IoBrComplexType.IoBrchInfo dataItem) {
		Params para = new Params();
