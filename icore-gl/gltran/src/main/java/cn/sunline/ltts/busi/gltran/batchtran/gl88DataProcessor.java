...
public class gl88DataProcessor extends
  AbstractBatchDataProcessorWithJobDataItem<cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Input, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Property, cn.sunline.ltts.busi.iobus.type.pb.IoBrComplexType.IoBrchInfo, cn.sunline.ltts.busi.gl.type.GlReport.GlCcyAndBranchList> {
	private static final BizLog bizlog = BizLogUtil.getBizLog(gl88DataProcessor.class);
	...
	/**
		 ...
		 */
		@Override
		public void process(String jobId, int index, cn.sunline.ltts.busi.gl.type.GlReport.GlCcyAndBranchList dataItem, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Input input, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Property property) {
			...
			bizlog.debug("trxnDate>>>>>>>>>>[%s]", trxnDate);
			...
			para.add(GlDict.A.file_name.getId(), FaConst.BUSINESS_CONDITION_ON +"_" + ccyCode + E_GLDATEINTERVAL.DAILY.getLongName());

			GlReport.genOneReport("GlInsideGenl", dataItem.getBranch_id(), E_CYCLETYPE.DAY, para);
			...
			if (DateTools2.isLastDay("M", trxnDate)) {
				...
				para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
				para.add(GlDict.A.ccy_code.getId(), ccyCode);
				para.add(GlDict.A.file_name.getId(), FaConst.BUSINESS_CONDITION_ON +"_" + ccyCode + E_GLDATEINTERVAL.MONTHLY.getLongName());
			...
			if (DateTools2.isLastDay("Q", trxnDate)) {
				...
				para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
				para.add(GlDict.A.ccy_code.getId(), ccyCode);
				para.add(GlDict.A.file_name.getId(), FaConst.BUSINESS_CONDITION_ON +"_" + ccyCode + E_GLDATEINTERVAL.SEASONLY.getLongName());
			...
			if (DateTools2.isLastDay("H", trxnDate)) {
				...
				para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
				para.add(GlDict.A.ccy_code.getId(), ccyCode);
				para.add(GlDict.A.file_name.getId(), FaConst.BUSINESS_CONDITION_ON +"_" + ccyCode + E_GLDATEINTERVAL.HALF_YEARLY.getLongName());
			...
			if (DateTools2.isLastDay("Y", trxnDate)) {
				...
				para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
				para.add(GlDict.A.ccy_code.getId(), ccyCode);
				para.add(GlDict.A.file_name.getId(), FaConst.BUSINESS_CONDITION_ON +"_" + ccyCode + E_GLDATEINTERVAL.YEARLY.getLongName());
			...
			if (CommToolsAplt.prcRunEnvs().getYreddt().equals(trxnDate)) {
				...
				para.add(GlDict.A.report_type.getId(), E_REPORTTYPE.BUSINETT_TYPE);
				para.add(GlDict.A.ccy_code.getId(), ccyCode);
				para.add(GlDict.A.file_name.getId(), FaConst.BUSINESS_CONDITION_ON +"_trial_" + ccyCode + E_GLDATEINTERVAL.YEARLY.getLongName());
		 ...
		 */
		@Override
		public BatchDataWalker<cn.sunline.ltts.busi.iobus.type.pb.IoBrComplexType.IoBrchInfo> getBatchDataWalker(cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Input input, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Property property) {
		 ...
		 * @return
		 */
		public BatchDataWalker<cn.sunline.ltts.busi.gl.type.GlReport.GlCcyAndBranchList> getJobBatchDataWalker(cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Input input, cn.sunline.ltts.busi.gltran.batchtran.intf.Gl88.Property property, cn.sunline.ltts.busi.iobus.type.pb.IoBrComplexType.IoBrchInfo dataItem) {
