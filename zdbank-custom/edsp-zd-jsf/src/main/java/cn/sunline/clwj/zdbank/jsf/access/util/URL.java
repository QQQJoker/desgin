...
/**
 * URL配置模型：protocol://host:port/path?parameters <br/>
 * 
 * @author EthanLiu liaoyr@sunline.cn 2016/12/23
 * @version 1.0
 */
public final class URL implements Serializable {
	...
	public String toIdentityString() {
		...
		return identity = buildString(true, false); // only return identity
													// message, see the method
													// "equals" and "hashCode"
	}

	public String toIdentityString(String... parameters) {
		return buildString(true, false, parameters); // only return identity
														// message, see the
														// method "equals" and
														// "hashCode"
	}
