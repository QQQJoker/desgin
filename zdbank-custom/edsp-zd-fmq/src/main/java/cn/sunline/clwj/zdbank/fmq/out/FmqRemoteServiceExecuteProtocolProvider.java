...
public class FmqRemoteServiceExecuteProtocolProvider implements RemoteServiceExecuteProtocolProvider {
	...
	public RemoteServiceExecuteProtocolHandler getRemoteServiceExecuteProtocolHandler() {
		return new FmqRemoteServiceExecuteProtocolHandler(config);
	}
